...
describe "投稿のテスト" do
  ...
  describe "投稿画面のテスト" do
    ...
    context "投稿処理のテスト" do
      it "投稿後のリダイレクト先は正しいか" do
        ...
        click_button "投稿"
        expect(page).tohave_current_path list_path(List.last)
      end
    end
  end

  describe "投稿の一覧テスト" do
    before do
      visit lists_path
    end
  ...
  describe "詳細画面のテスト" do
    ...
    context "リンクの遷移先の確認" do
      it "編集の遷移先は編集画面か" do
        ...
        edit_link.click
        expect(currnt_path).to eq("/lists/" + list.id.to_s + "/edit")
      end
    end
  ...
  describe "編集画面のテスト" do
    ...
    context "表示の確認" do
      it "編集前のタイトルと本文がフォームに表示(セットされている)" do
